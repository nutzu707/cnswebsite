        ...
        <div className="self-center pt-16 lg:pt-32 space-y-10">
            {currentItems.map((item, index) => (
                <a
                    href={item.link}
                    key={index}
                    className="flex flex-col shadow-2xl rounded-2xl w-full lg:min-h-0 lg:w-[1000px] lg:h-[259px] cursor-pointer lg:flex-row border-2 border-solid border-[#E5E7EB]"
                >
